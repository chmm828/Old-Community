...
export default {
  ...
  methods: {
    ...
    findApplicationIsOkPage() {
      ...
      this.$http
        .post("/api/adminAppApi/findApplicationIsOkPage", this.queryInfo)
        .then(res => {
          // console.log("====>", res);
    ...
    findApplicationIsOk() {
      ...
      this.$http
        .post("/api/adminAppApi/findApplicationIsOk", userInfo)
        .then(res => {
    ...
    findAppIdIsOkPage() {
      ...
      this.$http
        .post("/api/adminAppApi/findAppIdIsOkPage", this.queryInfo)
        .then(res => {
          this.userData = res.data || [];
          this.loading = false;
        });
    ...
    findAppIdIsOkTotal() {
      this.queryInfo.u_id = sessionStorage.getItem("user_id");
      this.$http
        .post("/api/adminAppApi/findAppIdIsOkTotal", this.queryInfo)
        .then(res => {
