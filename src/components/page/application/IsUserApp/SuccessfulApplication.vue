  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>申请通过的记录</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
      ...
      <el-row>
        <el-col :span="6">
          <el-input
            ...
            clearable
          >
            <el-button slot="append" icon="el-icon-search" @click="findAppIdIsOkPage" />
          </el-input>
        </el-col>
        <el-col :span="2">
...
export default {
  ...
  methods: {
    ...
    findAppIdIsOkPage() {
      ...
      this.loading = true;
      this.findAppIdIsOkTotal();
      this.$http
        .post("/api/userAppApi/findAppIdIsOkPage", this.queryInfo)
        .then(res => {
          this.userData = res.data || [];
          this.loading = false;
        });
    ...
    findAppIdIsOkTotal() {
      this.queryInfo.u_id = sessionStorage.getItem("user_id");
      this.$http
        .post("/api/userAppApi/findAppIdIsOkTotal", this.queryInfo)
        .then(res => {
