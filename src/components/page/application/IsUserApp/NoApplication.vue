  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>未通过的申请记录</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    ...
    findApplicationIsNoOkPage() {
      ...
      this.$http
        .post("/api/userAppApi/findApplicationIsNoOkPage", this.queryInfo)
        .then(res => {
          // console.log("====>", res);
    ...
    findAppIdIsOkPage() {
      ...
      this.$http
        .post("/api/userAppApi/findAppIdIsNoOkPage", this.queryInfo)
        .then(res => {
          this.userData = res.data || [];
          this.loading = false;
        });
    ...
    findAppIdIsNoOkTotal() {
      this.queryInfo.u_id = sessionStorage.getItem("user_id");
      this.$http
        .post("/api/userAppApi/findAppIdIsNoOkTotal", this.queryInfo)
        .then(res => {
