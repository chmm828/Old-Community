  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>待审核的申请</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    ...
    findApplicationIsWaitPage() {
      ...
      this.$http
        .post("/api/userAppApi/findApplicationIsWaitPage", this.queryInfo)
        .then(res => {
          console.log("====>", res);
    ...
    findAppIdPage() {
      ...
      this.$http
        .post("/api/userAppApi/findAppIdPage", this.queryInfo)
        .then(res => {
          this.userData = res.data || [];
          this.loading = false;
        });
    ...
    finddAppIdTotal() {
      this.queryInfo.u_id = sessionStorage.getItem("user_id");
      this.$http
        .post("/api/userAppApi/findAppIdTotal", this.queryInfo)
        .then(res => {
